                ...
                <div class="tab-content" id="myTabContent">
                        ...
                        <div class="card largeImg">
                          <div class="card-img-wrap">
                            <div class="card-img-tag-top">
                              ...
                              <?php } else if ($value['status'] == 0 || $value['status'] == 4) { ?>
                  ...
                  <div class="row cardWrap tab-pane fade show" id="Online-queue" role="tabpanel" aria-labelledby="Online-publish-tab">
                    ...
                    foreach ($camp_online_all as $key => $value) {
                      ...
                      if (isset($value['status']) && ($value['status'] == 0 || $value['status'] == 4)) {
                    ?>
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                          <div class="card largeImg">
                            <div class="card-img-wrap">
              ...
              <div class="tab-pane fade " id="Onsite" role="tabpanel" aria-labelledby="Onsite-tab">
                ...
                <div class="filterWrapper row g-0">
                  <div class="col-md-4">
                    <ul class="nav nav-tabs">
                      <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="Onsite-publish-tab" data-bs-toggle="tab" data-bs-target="#Onsite-all" type="button" role="tab" aria-controls="Onsite" aria-selected="true">All</button>

                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="Onsite-publish-tab" data-bs-toggle="tab" data-bs-target="#Onsite-accepted" type="button" role="tab" aria-controls="Onsite" aria-selected="true">Accepted</button>
                      </li>
                      <li class="nav-item" role="presentation">
                        <button class="nav-link" id="Onsite-publish-tab" data-bs-toggle="tab" data-bs-target="#Onsite-queue" type="button" role="tab" aria-controls="Onsite" aria-selected="true">In Queue</button>
                      </li>
                    </ul>
                  </div>
                  <div class="col-md-8">
                ...
                <!-- Filter Div Ends-->
                <div class="tab-content" id="myTabContent">
                  <div class="row cardWrap tab-pane fade show active" id="Onsite-all" role="tabpanel" aria-labelledby="Onsite-publish-tab">
                    <!--  -->
                    <?php
                    // echo "<pre>";print_r($camp_online_all);die;
                  ...
                  <div class="row cardWrap tab-pane fade show" id="Onsite-accepted" role="tabpanel" aria-labelledby="Onsite-publish-tab">
                    <?php
                    foreach ($camp_onsite_all as $key => $value) {
                      if (isset($value['status']) && $value['status'] == 1) {
                    ?>
                  ...
                  <div class="row cardWrap tab-pane fade show" id="Onsite-queue" role="tabpanel" aria-labelledby="Onsite-publish-tab">
                    <?php
                    foreach ($camp_onsite_all as $key => $value) {
                      // echo $value['status'];continue;
                      if (isset($value['status']) && ($value['status'] == 0 || $value['status'] == 4)) {
